...
select name,COALESCE(mobile,'07986 444 2266') as mob from teacher
...
-- 10. se CASE to show the name of each teacher followed by 'Sci' if the teacher is in dept 1 or 2, show 'Art' if the teacher's dept is 3 and 'None' otherwise.
